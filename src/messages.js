...
const messages = [
	...
	{ id: 2, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'обработано', gservice: 'Backoffice', service: 'Backoffice', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
	...
	{ id: 5, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'блокировано, ошибка', gservice: 'Backoffice', service: 'Задания', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
	...
	{ id: 10, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'ошибка', gservice: 'Backoffice', service: 'Backoffice', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
	...
	{ id: 18, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'блокировано', gservice: 'Backoffice', service: 'Почта заданий', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
	{ id: 19, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'обработано', gservice: 'Backoffice', service: 'Задания', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
	...
	{ id: 28, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'ошибка', gservice: 'Backoffice', service: 'Почта согласований', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
	...
	{ id: 31, date: '01.12.19 \u2501 10:15:35', digest: 'Напишите отчет', state: 'в работе', gservice: 'Backoffice', service: 'Backoffice', type: 'lorem ipsum some text', info: 'отправлено исполнителям' },
