...
export default new Vuex.Store({
	state: {
		...
		fullWindow: false,
		widget1: [
			{ id: 0, 'x': 0, 'y': 0, 'w': 2, 'h': 2, 'i': '0', selected: true, text: 'Мои поручения' },
			{ id: 1, 'x': 2, 'y': 0, 'w': 2, 'h': 4, 'i': '1', selected: true, text: 'Просрочено' },
			{ id: 2, 'x': 4, 'y': 0, 'w': 2, 'h': 5, 'i': '2', selected: false, text: '' },
			{ id: 3, 'x': 6, 'y': 0, 'w': 2, 'h': 3, 'i': '3', selected: true, text: 'На контроле' },
			{ id: 4, 'x': 8, 'y': 0, 'w': 2, 'h': 3, 'i': '4', selected: false, text: '' },
			{ id: 5, 'x': 10, 'y': 0, 'w': 2, 'h': 3, 'i': '5', selected: false, text: '' },
			{ id: 6, 'x': 0, 'y': 5, 'w': 2, 'h': 5, 'i': '6', selected: true, text: 'Делегировано' },
			{ id: 7, 'x': 2, 'y': 5, 'w': 2, 'h': 5, 'i': '7', selected: false, text: '' },
			{ id: 8, 'x': 4, 'y': 5, 'w': 2, 'h': 5, 'i': '8', selected: true, text: 'Выполнено' },
			{ id: 9, 'x': 6, 'y': 3, 'w': 2, 'h': 4, 'i': '9', selected: false, text: '' },
			{ id: 10, 'x': 8, 'y': 4, 'w': 2, 'h': 4, 'i': '10', selected: false, text: '' },
			{ id: 11, 'x': 10, 'y': 4, 'w': 2, 'h': 4, 'i': '11', selected: false, text: '' },
			{ id: 12, 'x': 0, 'y': 10, 'w': 2, 'h': 5, 'i': '12', selected: false, text: '' },
			{ id: 13, 'x': 2, 'y': 10, 'w': 2, 'h': 5, 'i': '13', selected: false, text: '' },
			{ id: 14, 'x': 4, 'y': 8, 'w': 2, 'h': 4, 'i': '14', selected: false, text: '' },
			{ id: 15, 'x': 6, 'y': 8, 'w': 2, 'h': 4, 'i': '15', selected: false, text: '' },
			{ id: 16, 'x': 8, 'y': 10, 'w': 2, 'h': 5, 'i': '16', selected: false, text: '' },
			{ id: 17, 'x': 10, 'y': 4, 'w': 2, 'h': 2, 'i': '17', selected: false, text: '' },
			{ id: 18, 'x': 0, 'y': 9, 'w': 2, 'h': 3, 'i': '18', selected: false, text: '' },
			{ id: 19, 'x': 2, 'y': 6, 'w': 2, 'h': 2, 'i': '19', selected: false, text: '' }
		],
		widget2: [
