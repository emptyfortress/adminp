...
export default new Vuex.Store({
	state: {
		...
		widget1: [
			...
			{ 'x': 4, 'y': 0, 'w': 2, 'h': 5, 'i': '2', selected: false },
			{ 'x': 6, 'y': 0, 'w': 2, 'h': 3, 'i': '3', selected: true },
			{ 'x': 8, 'y': 0, 'w': 2, 'h': 3, 'i': '4', selected: false },
			{ 'x': 10, 'y': 0, 'w': 2, 'h': 3, 'i': '5', selected: false },
			{ 'x': 0, 'y': 5, 'w': 2, 'h': 5, 'i': '6', selected: true },
			{ 'x': 2, 'y': 5, 'w': 2, 'h': 5, 'i': '7', selected: false },
			{ 'x': 4, 'y': 5, 'w': 2, 'h': 5, 'i': '8', selected: true },
			{ 'x': 6, 'y': 3, 'w': 2, 'h': 4, 'i': '9', selected: false },
			{ 'x': 8, 'y': 4, 'w': 2, 'h': 4, 'i': '10', selected: false },
			{ 'x': 10, 'y': 4, 'w': 2, 'h': 4, 'i': '11', selected: false },
			{ 'x': 0, 'y': 10, 'w': 2, 'h': 5, 'i': '12', selected: false },
			{ 'x': 2, 'y': 10, 'w': 2, 'h': 5, 'i': '13', selected: false },
			{ 'x': 4, 'y': 8, 'w': 2, 'h': 4, 'i': '14', selected: false },
			{ 'x': 6, 'y': 8, 'w': 2, 'h': 4, 'i': '15', selected: false },
			{ 'x': 8, 'y': 10, 'w': 2, 'h': 5, 'i': '16', selected: false },
			{ 'x': 10, 'y': 4, 'w': 2, 'h': 2, 'i': '17', selected: false },
			{ 'x': 0, 'y': 9, 'w': 2, 'h': 3, 'i': '18', selected: false },
			{ 'x': 2, 'y': 6, 'w': 2, 'h': 2, 'i': '19', selected: false }
		],
		widget2: [
